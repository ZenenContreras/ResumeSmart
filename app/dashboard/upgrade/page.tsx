      ...
      <div className="mt-16 max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="border-b pb-6">
            <h3 className="font-semibold text-lg mb-2">Can I upgrade from Pro to Ultimate?</h3>
            <p className="text-gray-600">
              Yes! If you upgrade to Ultimate, you'll get 999 credits (unlimited) for 90 days from the upgrade date.
            </p>
          </div>
          <div className="border-b pb-6">
            <h3 className="font-semibold text-lg mb-2">What happens after 90 days on Ultimate?</h3>
            <p className="text-gray-600">
              Your account will revert to the Free plan. You can purchase another Ultimate package or Pro credits anytime.
            </p>
          </div>
          <div className="border-b pb-6">
            <h3 className="font-semibold text-lg mb-2">Do Pro credits expire?</h3>
            <p className="text-gray-600">
              No! Pro credits never expire. Use them whenever you need.
            </p>
          </div>
          <div className="border-b pb-6">
            <h3 className="font-semibold text-lg mb-2">How does credit deduction work?</h3>
            <p className="text-gray-600">
              Each time you download a resume as PDF, 1 credit is deducted from your account. Free users get 1 credit, Pro users get 10 credits, and Ultimate users get unlimited credits for 90 days.
            </p>
          </div>
          <div className="pb-6">
